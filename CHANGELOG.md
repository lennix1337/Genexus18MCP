...
- Cache successfully confirmed empty source parts for the read-cache TTL, so repeated full scans skip their SDK resolution; SDK read failures remain uncached and normal write invalidation clears both positive and negative entries.
